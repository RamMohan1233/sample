...
public class ProductController {
	...
	public List<Product> getAllProducts() {
		...
		if(prodList.isEmpty()) {
			...
			addProdIfEmpty(new Product(1,"TAYOTA","tayota is good adventures car and its going good","RAM MOHAN",1234567,"Below 50L", 350,0,0,"yes","./assets/images/tayota.jpg"));
			addProdIfEmpty(new Product(1,"LAMBORGHINI","lamborghini is precious car entire world...!","RAM MOHAN",1234567,"Precious Car", 350,0,0,"yes","./assets/images/lamborgini.jpg"));
			addProdIfEmpty(new Product(2,"VOLVO","volvo is good precious car and its good","RAM MOHAN",1234567,"Below 50L", 350,0,0,"yes","./assets/images/volvo.jpeg"));
			addProdIfEmpty(new Product(1,"LEXUS","its going good","RAM MOHAN",1234567,"precious Car", 350,0,0,"yes","./assets/images/lexus.jpg"));
			addProdIfEmpty(new Product(1,"porsche","porsche is going good racing car and its good for racers","RAM MOHAN",1234567,"precious car", 350,0,0,"yes","./assets/images/porsche.jpg"));
			addProdIfEmpty(new Product(1,"Astro Martin","astro is gooing good ","RAM MOHAN",1234567,"Below 50L", 350,0,0,"yes","./assets/images/Aston.jpg"));
